...
so_thymo_transcripts <- sleuth_load("01_processed_data/Bulk_RNAseq_quantification/sleuth/thymocyte_transcript_mode_default_filter_with_Turner_no_ribosomal_proteins_RNAs")
so_thymo_genes <- sleuth_load("01_processed_data/Bulk_RNAseq_quantification/sleuth/thymocyte_gene_mode_default_filter_with_Turner_no_ribosomal_proteins_RNAs")
