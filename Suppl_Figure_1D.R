...
res_lrt <- fread("Supplementary Table 4")
...
pdf("04_plots/Suppl_Figure_1D_right.pdf",width = 12,height = 16)
set.seed(13)
...
ggsave("04_plots/Suppl_Figure_1D_left_CLUSTER.pdf",width = 6,height = 14, 
