...
#write.table(sort(pca_thymo$rotation[abs(pca_thymo$rotation[,1]) > 0.01,1],decreasing = T),"/mnt/wwn-0x5000cca2b0dc9d33-part1/thymocyte_development_April_2024/02_tidy_data/GSEA/software_inputs/PCA_fig1b_PC1_and_PC2_preranked/thymocyte_PCA_component1.rnk",quote = F,sep = "\t",col.names = F)
#write.table(sort(pca_thymo$rotation[abs(pca_thymo$rotation[,2]) > 0.01,2],decreasing = T),"/mnt/wwn-0x5000cca2b0dc9d33-part1/thymocyte_development_April_2024/02_tidy_data/GSEA/software_inputs/PCA_fig1b_PC1_and_PC2_preranked/thymocyte_PCA_component2.rnk",quote = F,sep = "\t",col.names = F)
...
ggsave2(filename = "04_plots/Suppl_Figure_1C.pdf",
...
ggsave2(filename = "04_plots/Suppl_Figure_1E.pdf", height = 20,
